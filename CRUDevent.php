...
$totalData = count($event_processed);
                ...
                <center>
                    <div class="card"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <form action="" method="post">
                                    <button type="submit" name="create_event" class="btn btn-success fw-bold">
                        ...
                        <table class="table table-light table-striped table-hover table-responsive"
                            ...
                            $sql = "SELECT * FROM event LIMIT $awalData, $jumlahData_perHalaman";
                            $eventResults = mysqli_query($con, $sql);
                            while ($event = mysqli_fetch_assoc($eventResults)) {
                                ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="updateEvent.php?id=<?php echo $event['id'] ?>"
                                        ...
                                        <a href="delete_event.php?id=<?php echo $event['id'] ?>"
                                            ...
                                            onclick="return confirm('Are you sure you want to delete this booked event?');"><img
