...
if (isset($_POST['create_food']) == true) {
    header('location:createFood_Drink.php');
    exit;
}
// untuk PAGINATION
...
$totalData = count($food_processed);
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col" style="padding: 0px;">
                <center>
                    <div class="card"
                        style="text-align: center; padding: 20px; border-radius: 8px; border: 1px solid grey; box-shadow: 0px 10px 10px rgba(0, 0, 0, 0.8); width: 70%; margin-top: 40px; margin-bottom: 40px;">
                        <div class="row">
                            ...
                            <div class="col">
                                <form action="" method="post">
                                    <button type="submit" name="create_food" class="btn btn-success fw-bold">
                        ...
                        <table class="table table-light table-striped table-hover table-responsive"
                            ...
                            $sql = "SELECT f.*, cat.name as category_name FROM food f, categories cat WHERE cat.id = f.category_id LIMIT $awalData, $jumlahData_perHalaman";
                            $foodResults = mysqli_query($con, $sql);
                            while ($food = mysqli_fetch_assoc($foodResults)) {
                                ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        echo $food['category_name'];
                                        ?>
                                    </td>
                                    <td>
                                        <?php
                                        echo '<img src="uploads/' . $food['image'] . '" alt="' . $food['image'] . '">';
                                        ?>
                                    </td>
                                    <td>
                                        <a href="updateFood_Drink.php?id=<?php echo $food['id'] ?>"
                                        ...
                                        <br>
                                        <a href="delete_food.php?id=<?php echo $food['id'] ?>"
                                            class="btn btn-danger mt-2 fw-bold"
                                            onclick="return confirm('Are you sure you want to delete this food?');"><img
