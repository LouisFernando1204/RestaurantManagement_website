    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col" style="padding: 0px;">
                <center>
                    <div class="card"
                        style="text-align: center; padding: 10px; border-radius: 8px; border: 1px solid grey; box-shadow: 0px 10px 10px rgba(0, 0, 0, 0.8); width: 60%; margin-top: 40px; margin-bottom: 40px;">
                        ...
                        <table class="table table-light table-striped table-hover table-responsive"
                            ...
                            // masih ngga bisa sesuai dengan pagination nya 
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                $keyword = $_POST['keyword'];
                                if (isset($_POST['search']) == true && isset($keyword) == true) {
                            ...
                            <div class="col">
                                ...
                                <script language="javascript">
                                    function goTo(page) {
                                        ...
                                        window.location.href = 'sellingreport.php?halaman=' + page;
